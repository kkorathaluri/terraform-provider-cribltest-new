...
page_title: "cribl-terraform_pipeline Resource - terraform-provider-cribl-terraform"
subcategory: ""
description: |-
  Pipeline Resource
---

# cribl-terraform_pipeline (Resource)
...
```shell
terraform import cribl-terraform_pipeline.my_cribl-terraform_pipeline "{ \"group_id\": \"\",  \"id\": \"\"}"
```
