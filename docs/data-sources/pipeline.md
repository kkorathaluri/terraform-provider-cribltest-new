...
page_title: "cribl-terraform_pipeline Data Source - terraform-provider-cribl-terraform"
subcategory: ""
description: |-
  Pipeline DataSource
---

# cribl-terraform_pipeline (Data Source)
...
```terraform
data "cribl-terraform_pipeline" "my_pipeline" {
