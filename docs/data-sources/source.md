...
- `subscriptions` (Attributes List) Subscriptions to events on forwarding endpoints. (see [below for nested schema](#nestedatt--fifty--subscriptions))
...
- `one` (Attributes) (see [below for nested schema](#nestedatt--input_grafana--one))
- `two` (Attributes) (see [below for nested schema](#nestedatt--input_grafana--two))

<a id="nestedatt--input_grafana--one"></a>
### Nested Schema for `input_grafana.one`
...
- `loki_auth` (Attributes) (see [below for nested schema](#nestedatt--input_grafana--one--loki_auth))
- `max_active_req` (Number) Maximum number of active requests per Worker Process. Use 0 for unlimited.
- `max_requests_per_socket` (Number) Maximum number of requests per socket before @{product} instructs the client to close the connection. Default is 0 (unlimited).
- `metadata` (Attributes List) Fields to add to events from this input (see [below for nested schema](#nestedatt--input_grafana--one--metadata))
- `pipeline` (String) Pipeline to process data from this Source before sending it through the Routes
- `port` (Number) Port to listen on
- `pq` (Attributes) (see [below for nested schema](#nestedatt--input_grafana--one--pq))
- `pq_enabled` (Boolean) Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers).
...
- `prometheus_auth` (Attributes) (see [below for nested schema](#nestedatt--input_grafana--one--prometheus_auth))
- `request_timeout` (Number) How long to wait for an incoming request to complete before aborting it. Use 0 to disable.
- `send_to_routes` (Boolean) Select whether to send data to Routes, or directly to Destinations.
- `socket_timeout` (Number) How long @{product} should wait before assuming that an inactive socket has timed out. To wait forever, set to 0.
- `streamtags` (List of String) Tags for filtering and grouping in @{product}
...
<a id="nestedatt--input_grafana--one--connections"></a>
### Nested Schema for `input_grafana.one.connections`
...
<a id="nestedatt--input_grafana--one--loki_auth"></a>
### Nested Schema for `input_grafana.one.loki_auth`
...
<a id="nestedatt--input_grafana--one--loki_auth--oauth_params"></a>
### Nested Schema for `input_grafana.one.loki_auth.oauth_params`
...
<a id="nestedatt--input_grafana--one--metadata"></a>
### Nested Schema for `input_grafana.one.metadata`
...
<a id="nestedatt--input_grafana--one--pq"></a>
### Nested Schema for `input_grafana.one.pq`
...
<a id="nestedatt--input_grafana--one--prometheus_auth"></a>
### Nested Schema for `input_grafana.one.prometheus_auth`
...
<a id="nestedatt--input_grafana--one--prometheus_auth--oauth_params"></a>
### Nested Schema for `input_grafana.one.prometheus_auth.oauth_params`
...
<a id="nestedatt--input_grafana--two"></a>
### Nested Schema for `input_grafana.two`
...
- `keep_alive_timeout` (Number) Maximum time to wait for additional data, after the last response was sent, before closing a socket connection. This can be very useful when Grafana Agent remote write's request frequency is high so, reusing connections, would help mitigating the cost of creating a new connection per request. Note that Grafana Agent's embedded Prometheus would attempt to keep connections open for up to 5 minutes.
- `loki_api` (String) Absolute path on which to listen for Loki logs requests. Defaults to /loki/api/v1/push, which will (in this example) expand as: 'http://<your‑upstream‑URL>:<your‑port>/loki/api/v1/push'. Either this field or 'Remote Write API endpoint' must be configured.
- `loki_auth` (Attributes) (see [below for nested schema](#nestedatt--input_grafana--two--loki_auth))
- `max_active_req` (Number) Maximum number of active requests per Worker Process. Use 0 for unlimited.
- `max_requests_per_socket` (Number) Maximum number of requests per socket before @{product} instructs the client to close the connection. Default is 0 (unlimited).
- `metadata` (Attributes List) Fields to add to events from this input (see [below for nested schema](#nestedatt--input_grafana--two--metadata))
- `pipeline` (String) Pipeline to process data from this Source before sending it through the Routes
- `port` (Number) Port to listen on
- `pq` (Attributes) (see [below for nested schema](#nestedatt--input_grafana--two--pq))
- `pq_enabled` (Boolean) Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers).
- `prometheus_api` (String) Absolute path on which to listen for Grafana Agent's Remote Write requests. Defaults to /api/prom/push, which will expand as: 'http://<your‑upstream‑URL>:<your‑port>/api/prom/push'. Either this field or 'Logs API endpoint' must be configured.
- `prometheus_auth` (Attributes) (see [below for nested schema](#nestedatt--input_grafana--two--prometheus_auth))
- `request_timeout` (Number) How long to wait for an incoming request to complete before aborting it. Use 0 to disable.
- `send_to_routes` (Boolean) Select whether to send data to Routes, or directly to Destinations.
- `socket_timeout` (Number) How long @{product} should wait before assuming that an inactive socket has timed out. To wait forever, set to 0.
- `streamtags` (List of String) Tags for filtering and grouping in @{product}
...
<a id="nestedatt--input_grafana--two--connections"></a>
### Nested Schema for `input_grafana.two.connections`
...
<a id="nestedatt--input_grafana--two--loki_auth"></a>
### Nested Schema for `input_grafana.two.loki_auth`
...
<a id="nestedatt--input_grafana--two--loki_auth--oauth_params"></a>
### Nested Schema for `input_grafana.two.loki_auth.oauth_params`
...
<a id="nestedatt--input_grafana--two--metadata"></a>
### Nested Schema for `input_grafana.two.metadata`
...
<a id="nestedatt--input_grafana--two--pq"></a>
### Nested Schema for `input_grafana.two.pq`
...
<a id="nestedatt--input_grafana--two--prometheus_auth"></a>
### Nested Schema for `input_grafana.two.prometheus_auth`
...
<a id="nestedatt--input_grafana--two--prometheus_auth--oauth_params"></a>
### Nested Schema for `input_grafana.two.prometheus_auth.oauth_params`
...
- `one` (Attributes) (see [below for nested schema](#nestedatt--input_syslog--one))
- `two` (Attributes) (see [below for nested schema](#nestedatt--input_syslog--two))

<a id="nestedatt--input_syslog--one"></a>
### Nested Schema for `input_syslog.one`
...
- `connections` (Attributes List) Direct connections to Destinations, and optionally via a Pipeline or a Pack (see [below for nested schema](#nestedatt--input_syslog--one--connections))
- `description` (String)
- `disabled` (Boolean)
- `enable_load_balancing` (Boolean) Load balance traffic across all Worker Processes
- `enable_proxy_header` (Boolean) Enable if the connection is proxied by a device that supports Proxy Protocol V1 or V2
...
- `max_buffer_size` (Number) Maximum number of events to buffer when downstream is blocking. Only applies to UDP.
- `metadata` (Attributes List) Fields to add to events from this input (see [below for nested schema](#nestedatt--input_syslog--one--metadata))
- `octet_counting` (Boolean) Enable if incoming messages use octet counting per RFC 6587.
- `pipeline` (String) Pipeline to process data from this Source before sending it through the Routes
- `pq` (Attributes) (see [below for nested schema](#nestedatt--input_syslog--one--pq))
- `pq_enabled` (Boolean) Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers).
- `send_to_routes` (Boolean) Select whether to send data to Routes, or directly to Destinations.
...
- `tls` (Attributes) (see [below for nested schema](#nestedatt--input_syslog--one--tls))
- `type` (String)
- `udp_port` (Number) Enter UDP port number to listen on. Not required if listening on TCP.
- `udp_socket_rx_buf_size` (Number) Optionally, set the SO_RCVBUF socket option for the UDP socket. This value tells the operating system how many bytes can be buffered in the kernel before events are dropped. Leave blank to use the OS default. Caution: Increasing this value will affect OS memory utilization.

<a id="nestedatt--input_syslog--one--connections"></a>
### Nested Schema for `input_syslog.one.connections`
...
<a id="nestedatt--input_syslog--one--metadata"></a>
### Nested Schema for `input_syslog.one.metadata`
...
<a id="nestedatt--input_syslog--one--pq"></a>
### Nested Schema for `input_syslog.one.pq`
...
### Nested Schema for `input_syslog.one.tls`
...
<a id="nestedatt--input_syslog--two"></a>
### Nested Schema for `input_syslog.two`

Read-Only:

- `allow_non_standard_app_name` (Boolean) Enable if RFC 3164-formatted messages have hyphens in the app name portion of the TAG section. If disabled, only alphanumeric characters and underscores are allowed. Ignored for RFC 5424-formatted messages.
- `connections` (Attributes List) Direct connections to Destinations, and optionally via a Pipeline or a Pack (see [below for nested schema](#nestedatt--input_syslog--two--connections))
- `description` (String)
- `disabled` (Boolean)
- `enable_load_balancing` (Boolean) Load balance traffic across all Worker Processes
- `enable_proxy_header` (Boolean) Enable if the connection is proxied by a device that supports Proxy Protocol V1 or V2
...
- `max_active_cxn` (Number) Maximum number of active connections allowed per Worker Process for TCP connections. Use 0 for unlimited.
- `max_buffer_size` (Number) Maximum number of events to buffer when downstream is blocking. Only applies to UDP.
- `metadata` (Attributes List) Fields to add to events from this input (see [below for nested schema](#nestedatt--input_syslog--two--metadata))
- `octet_counting` (Boolean) Enable if incoming messages use octet counting per RFC 6587.
- `pipeline` (String) Pipeline to process data from this Source before sending it through the Routes
- `pq` (Attributes) (see [below for nested schema](#nestedatt--input_syslog--two--pq))
- `pq_enabled` (Boolean) Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers).
- `send_to_routes` (Boolean) Select whether to send data to Routes, or directly to Destinations.
- `single_msg_udp_packets` (Boolean) Treat UDP packet data received as full syslog message
- `socket_ending_max_wait` (Number) How long the server will wait after initiating a closure for a client to close its end of the connection. If the client doesn't close the connection within this time, the server will forcefully terminate the socket to prevent resource leaks and ensure efficient connection cleanup and system stability. Leave at 0 for no inactive socket monitoring.
...
- `tcp_port` (Number) Enter TCP port number to listen on. Not required if listening on UDP.
- `timestamp_timezone` (String) Timezone to assign to timestamps without timezone info
- `tls` (Attributes) (see [below for nested schema](#nestedatt--input_syslog--two--tls))
- `type` (String)
- `udp_port` (Number) Enter UDP port number to listen on. Not required if listening on TCP.
- `udp_socket_rx_buf_size` (Number) Optionally, set the SO_RCVBUF socket option for the UDP socket. This value tells the operating system how many bytes can be buffered in the kernel before events are dropped. Leave blank to use the OS default. Caution: Increasing this value will affect OS memory utilization.

<a id="nestedatt--input_syslog--two--connections"></a>
### Nested Schema for `input_syslog.two.connections`
...
<a id="nestedatt--input_syslog--two--metadata"></a>
### Nested Schema for `input_syslog.two.metadata`
...
<a id="nestedatt--input_syslog--two--pq"></a>
### Nested Schema for `input_syslog.two.pq`
...
### Nested Schema for `input_syslog.two.tls`
