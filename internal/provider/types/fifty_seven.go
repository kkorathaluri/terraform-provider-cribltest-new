...
type FiftySeven struct {
	...
	AuthTokens                []InputAuthTokens             `tfsdk:"auth_tokens"`
	CaptureHeaders            types.Bool                    `tfsdk:"capture_headers"`
	Connections               []Input57Connections          `tfsdk:"connections"`
