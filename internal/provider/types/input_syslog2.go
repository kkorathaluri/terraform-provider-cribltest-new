...
type InputSyslog2 struct {
	...
	Connections                []InputInputSyslogConnections          `tfsdk:"connections"`
	...
	Metadata                   []InputInputSyslogMetadata             `tfsdk:"metadata"`
	OctetCounting              types.Bool                             `tfsdk:"octet_counting"`
	Pipeline                   types.String                           `tfsdk:"pipeline"`
	Pq                         *InputInputSyslogPq                    `tfsdk:"pq"`
	...
	TLS                        *InputInputSyslogTLSSettingsServerSide `tfsdk:"tls"`
