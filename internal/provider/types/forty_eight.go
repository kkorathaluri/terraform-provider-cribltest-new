...
type FortyEight struct {
	...
	Connections         []Input48Connections        `tfsdk:"connections"`
	...
	Metadata            []Input48Metadata           `tfsdk:"metadata"`
	Pipeline            types.String                `tfsdk:"pipeline"`
	Port                types.Number                `tfsdk:"port"`
	Pq                  *Input48Pq                  `tfsdk:"pq"`
	PqEnabled           types.Bool                  `tfsdk:"pq_enabled"`
	Preprocess          *InputPreprocess            `tfsdk:"preprocess"`
	...
	Status              *Input48Status              `tfsdk:"status"`
	Streamtags          []types.String              `tfsdk:"streamtags"`
	TLS                 *InputTLSSettingsServerSide `tfsdk:"tls"`
