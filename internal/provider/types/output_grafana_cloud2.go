...
type OutputGrafanaCloud2 struct {
	...
	ExtraHTTPHeaders              []OutputOutputGrafanaCloudExtraHTTPHeaders      `tfsdk:"extra_http_headers"`
	...
	LokiAuth                      *OutputOutputGrafanaCloudLokiAuth               `tfsdk:"loki_auth"`
	...
	PqControls                    *OutputOutputGrafanaCloudPqControls             `tfsdk:"pq_controls"`
	...
	PrometheusAuth                *OutputOutputGrafanaCloudPrometheusAuth         `tfsdk:"prometheus_auth"`
	...
	ResponseRetrySettings         []OutputOutputGrafanaCloudResponseRetrySettings `tfsdk:"response_retry_settings"`
	SafeHeaders                   []types.String                                  `tfsdk:"safe_headers"`
	Status                        *TFStatus                                       `tfsdk:"status"`
	Streamtags                    []types.String                                  `tfsdk:"streamtags"`
	SystemFields                  []types.String                                  `tfsdk:"system_fields"`
	TimeoutRetrySettings          *OutputOutputGrafanaCloudTimeoutRetrySettings   `tfsdk:"timeout_retry_settings"`
