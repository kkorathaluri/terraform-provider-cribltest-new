...
type InputGrafana2 struct {
	...
	Connections           []InputInputGrafanaConnections          `tfsdk:"connections"`
	...
	Metadata              []InputInputGrafanaMetadata             `tfsdk:"metadata"`
	Pipeline              types.String                            `tfsdk:"pipeline"`
	Port                  types.Float64                           `tfsdk:"port"`
	Pq                    *InputInputGrafanaPq                    `tfsdk:"pq"`
	...
	TLS                   *InputInputGrafanaTLSSettingsServerSide `tfsdk:"tls"`
