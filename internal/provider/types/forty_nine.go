...
type FortyNine struct {
	...
	Connections         []Input49Connections          `tfsdk:"connections"`
	...
	Metadata            []Input49Metadata             `tfsdk:"metadata"`
	Persistence         *InputPersistence             `tfsdk:"persistence"`
	Pipeline            types.String                  `tfsdk:"pipeline"`
	Port                types.Number                  `tfsdk:"port"`
	Pq                  *Input49Pq                    `tfsdk:"pq"`
	...
	Status              *Input49Status                `tfsdk:"status"`
	Streamtags          []types.String                `tfsdk:"streamtags"`
	TextSecret          types.String                  `tfsdk:"text_secret"`
	TLS                 *Input49TLSSettingsServerSide `tfsdk:"tls"`
