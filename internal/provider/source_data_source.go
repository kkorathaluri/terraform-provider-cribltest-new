...
type SourceDataSourceModel struct {
	...
	Fifty                     *tfTypes.Fifty                     `queryParam:"inline" tfsdk:"fifty" tfPlanOnly:"true"`
	FiftyFive                 *tfTypes.FiftyFive                 `queryParam:"inline" tfsdk:"fifty_five" tfPlanOnly:"true"`
	FiftyFour                 *tfTypes.FiftyFour                 `queryParam:"inline" tfsdk:"fifty_four" tfPlanOnly:"true"`
	FiftyOne                  *tfTypes.FiftyOne                  `queryParam:"inline" tfsdk:"fifty_one" tfPlanOnly:"true"`
	FiftySeven                *tfTypes.FiftySeven                `queryParam:"inline" tfsdk:"fifty_seven" tfPlanOnly:"true"`
	FiftySix                  *tfTypes.FiftySix                  `queryParam:"inline" tfsdk:"fifty_six" tfPlanOnly:"true"`
	FiftyThree                *tfTypes.FiftyThree                `queryParam:"inline" tfsdk:"fifty_three" tfPlanOnly:"true"`
	FiftyTwo                  *tfTypes.FiftyTwo                  `queryParam:"inline" tfsdk:"fifty_two" tfPlanOnly:"true"`
	FortyEight                *tfTypes.FortyEight                `queryParam:"inline" tfsdk:"forty_eight" tfPlanOnly:"true"`
	FortyNine                 *tfTypes.FortyNine                 `queryParam:"inline" tfsdk:"forty_nine" tfPlanOnly:"true"`
	FortySeven                *tfTypes.FortySeven                `queryParam:"inline" tfsdk:"forty_seven" tfPlanOnly:"true"`
...
func (r *SourceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"fifty": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
					...
					"status": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"metrics": schema.SingleNestedAttribute{
								Computed: true,
								Attributes: map[string]schema.Attribute{
									"buffered": schema.NumberAttribute{
										Computed: true,
									},
									"dropped": schema.NumberAttribute{
										Computed: true,
									},
									"received": schema.NumberAttribute{
										Computed: true,
									},
								},
							},
			...
			"fifty_five": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
					"connections": schema.ListNestedAttribute{
						Computed: true,
			...
			"fifty_four": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
			...
			"fifty_one": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
			...
			"fifty_seven": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
			...
			"fifty_six": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
			...
			"fifty_three": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
					"connections": schema.ListNestedAttribute{
						Computed: true,
			...
			"fifty_two": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
					"connections": schema.ListNestedAttribute{
						Computed: true,
			...
			"forty_eight": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
					"auth_type": schema.StringAttribute{
						Computed:    true,
			...
			"forty_nine": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
			...
			"forty_seven": schema.SingleNestedAttribute{
				Computed: true,
				Attributes: map[string]schema.Attribute{
					"breaker_rulesets": schema.ListAttribute{
						Computed:    true,
...
func (r *SourceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	res, err := r.client.Inputs.ListInput(ctx)
	if err != nil {
	...
	data.RefreshFromSharedInput(&res.Object.Items[0])
